...
describe('HelpTopicLink', () => {
  test('should enable topic when component is mounted and disable when unmounted', () => {
  ...
  test('should set active topic when button is clicked', () => {
